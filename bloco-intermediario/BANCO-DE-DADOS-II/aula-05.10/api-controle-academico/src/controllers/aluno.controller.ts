...
export class AlunoController {
	...
	public async create(req: Request, res: Response) {
		...
		const novoAluno = await service.cadastrar({
			email,
			nome,
			senha,
			idade,
	...
	public async update(req: Request, res: Response) {
		...
		const alunoAtualizado = await service.atualizar({id: id, nome: nome, idade: idade, senha: senha})
	...
	public async login(req: Request, res: Response) {
		...
		const token = await service.login({ email: email, senha: senha})
